			...
			<div className="p-6 animate-fade-up">
				...
				<div className="grid grid-cols-3 gap-4 mb-5">
					{[
						{
							l: "Total Pembelian",
							v: dealerPurchaseGroups.length,
							c: "text-zinc-900",
						},
						{
							l: "Garansi Aktif",
							v: dealerPurchaseGroups.filter(
								(g) => getGroupStatus(g) === "active",
							).length,
							c: "text-emerald-600",
						},
						{
												...
												<TableCell>
													<div>
														<p className="text-xs text-zinc-500">
															{formatDateShort(g.warrantyEndDate)}
														</p>
														{days > 0 && days < 180 && (
