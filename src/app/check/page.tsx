...
import { mockProducts } from "@/mock/mock-data";
import {
	Search,
	Shield,
	ShieldOff,
			...
			<div className="max-w-lg mx-auto px-6 py-14 animate-fade-up">
				...
				{state === "idle" && (
					<div className="text-center mb-10">
						...
						<p className="text-sm text-zinc-500">
							Masukkan serial number produk Anda
						</p>
					</div>
				)}
				...
				{state === "found" && found && (
					<div className="space-y-4 animate-fade-up">
						<div
							className={`rounded-2xl border p-5 ${found.warrantyStatus === "active" ? "bg-emerald-50 border-emerald-200" : "bg-red-50 border-red-200"}`}>
							<div className="flex items-center gap-3 mb-4">
								<div
									className={`p-2.5 rounded-xl ${found.warrantyStatus === "active" ? "bg-emerald-100" : "bg-red-100"}`}>
									{found.warrantyStatus === "active" ? (
								...
								<div>
									<p
										className={`font-semibold text-base ${found.warrantyStatus === "active" ? "text-emerald-800" : "text-red-800"}`}>
										{found.warrantyStatus === "active"
											? "Garansi Aktif"
											: "Garansi Berakhir"}
									</p>
							...
							<div className="bg-white/70 rounded-xl p-4 grid grid-cols-2 gap-x-6 gap-y-3">
								{[
									...
									{
										l: "Mulai Garansi",
										v: found.warrantyStartDate
											? formatDateShort(found.warrantyStartDate)
											: "—",
									},
									{
										l: "Berakhir",
										v: found.warrantyEndDate
											? formatDateShort(found.warrantyEndDate)
											: "—",
									},
								].map((item) => (
									<div key={item.l}>
				...
				{state === "submitted" && (
					<div className="bg-white border border-zinc-200 rounded-2xl shadow-sm p-8 text-center animate-fade-up">
						...
						<p className="text-xs text-zinc-500 mb-0.5">
							Kami akan mengirim notifikasi ke
						</p>
				...
				<p className="text-center text-[11px] text-zinc-400 mt-8">
					Butuh bantuan?{" "}
					<a
						href="mailto:info@kassen.com.tw"
