...
export default function CustomersPage() {
  ...
  const load = useCallback(async () => {
    setLoading(true);
    // const result = await customerAdapter.getPaginated({ page, pageSize, search: search || undefined });
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[var(--bg)]">
      ...
      <main className="flex-1 p-6 space-y-5 animate-fade-up">
        ...
        <Card>
          <CardHeader title="Daftar Customer" description="Data customer dari semua dealer" />
                    ...
                    <tr>
                      <td colSpan={7}>
                        <EmptyState
                          ...
                          description={search ? "Coba ubah kata kunci pencarian" : "Belum ada data customer"}
                        />
                      </td>
                    </tr>
                  ) : (
